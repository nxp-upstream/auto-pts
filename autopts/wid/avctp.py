...
from autopts.pybtp.types import WIDParams, BTPError
...
def hdl_wid_1(_: WIDParams):
    """
    description: Attempt to connect another AVCTP channel using the same PSM.  The second attempt should not be allowed to be sent.
    """
    try:
