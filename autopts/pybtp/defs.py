...
BTP_A2DP_CMD_ROLE_SOURCE = 0x00
BTP_A2DP_CMD_ROLE_SINK = 0x01
BTP_A2DP_CMD_CODEC_SBC = 0x01
BTP_A2DP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_A2DP_CMD_REGISTER_EP = 0x02
BTP_A2DP_CMD_CONNECT = 0x03
BTP_A2DP_CMD_DISCOVER = 0x04
BTP_A2DP_CMD_CONFIGURE = 0x05
BTP_A2DP_CMD_ESTABLISH = 0x06
BTP_A2DP_CMD_START = 0x07
BTP_A2DP_CMD_SUSPEND = 0x08
BTP_A2DP_CMD_RELEASE = 0x09
BTP_A2DP_CMD_ABORT = 0x0A
BTP_A2DP_CMD_RECONFIGURE = 0x0B
BTP_A2DP_EV_CONNECTED = 0x81
BGP_A2DP_EV_GET_CAPABILITIES_RSP = 0x82
BTP_A2DP_EV_SET_CONFIGURATION_RSP = 0x83
BTP_A2DP_EV_ESTABLISH_RSP = 0x84
BTP_A2DP_EV_RELEASE_RSP = 0x85
BTP_A2DP_EV_START_RSP = 0x86
BTP_A2DP_EV_SUSPEND_RSP = 0x87
BTP_A2DP_EV_DISCONNECTED = 0x88
BTP_A2DP_EV_ABORT_RSP = 0x89
BTP_A2DP_EV_RECV_MEDIA = 0x8A
...
BTP_AVRCP_CMD_INFORM_DISPLAYABLE_CHAR_SET = 0x10
BTP_AVRCP_CMD_INFORM_BATT_STATUS_OF_CT = 0x11
BTP_AVRCP_CMD_GET_ELEMENT_ATTRS = 0x12
BTP_AVRCP_CMD_GET_PLAY_STATUS = 0x13
BTP_AVRCP_CMD_REGISTER_NOTIFICATION = 0x14
BTP_AVRCP_CMD_REQ_CONTINUING_RSP = 0x15
BTP_AVRCP_CMD_ABORT_CONTINUING_RSP = 0x16
BTP_AVRCP_CMD_SET_ABSOLUTE_VOLUME = 0x17
BTP_AVRCP_CMD_SET_ADDRESSED_PLAYER = 0x18
BTP_AVRCP_CMD_GET_FOLDER_ITEMS = 0x19
BTP_AVRCP_CMD_GET_TOTAL_NUMBER_OF_ITEMS = 0x1A
BTP_AVRCP_CMD_SET_BROWSED_PLAYER = 0x1B
BTP_AVRCP_CMD_CHANGE_PATH = 0x1C
BTP_AVRCP_CMD_GET_ITEM_ATTRS = 0x1D
BTP_AVRCP_CMD_PLAY_ITEM = 0x1E
BTP_AVRCP_CMD_SEARCH = 0x1F
BTP_AVRCP_CMD_ADD_TO_NOW_PLAYING = 0x20
BTP_AVRCP_CMD_GENERAL_REJECT = 0x21
BTP_AVRCP_CMD_TG_REGISTER_NOTIFICATION = 0x22
BTP_AVRCP_CMD_TG_PREPARE_LONG_METADATA = 0x23
BTP_AVRCP_CMD_TG_CHANGE_PATH = 0x24
BTP_AVRCP_CMD_CA_CT_CONNECT = 0x25
BTP_AVRCP_CMD_CA_CT_DISCONNECT = 0x26
BTP_AVRCP_CMD_GET_IMAGE_PROPS = 0x27
BTP_AVRCP_CMD_GET_IMAGE = 0x28
BTP_AVRCP_CMD_GET_LINKED_THUMBNAIL = 0x29
BTP_AVRCP_CMD_TG_PLAY_ITEM_WITHOUT_COVER_ART = 0x30
...
BTP_AVRCP_EV_INFORM_DISPLAYABLE_CHAR_SET_RSP = 0x8E
BTP_AVRCP_EV_INFORM_BATT_STATUS_OF_CT_RSP = 0x8F
BTP_AVRCP_EV_GET_ELEMENT_ATTRS_RSP = 0x90
BTP_AVRCP_EV_GET_PLAY_STATUS_RSP = 0x91
BTP_AVRCP_EV_REGISTER_NOTIFICATION_RSP = 0x92
BTP_AVRCP_EV_REQ_CONTINUING_RSP_RSP = 0x93
BTP_AVRCP_EV_ABORT_CONTINUING_RSP_RSP = 0x94
BTP_AVRCP_EV_SET_ABSOLUTE_VOLUME_RSP = 0x95
BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_RSP = 0x96
BTP_AVRCP_EV_GET_FOLDER_ITEMS_RSP = 0x97
BTP_AVRCP_EV_GET_TOTAL_NUMBER_OF_ITEMS_RSP = 0x98
BTP_AVRCP_EV_SET_BROWSED_PLAYER_RSP = 0x99
BTP_AVRCP_EV_CHANGE_PATH_RSP = 0x9A
BTP_AVRCP_EV_GET_ITEM_ATTRS_RSP = 0x9B
BTP_AVRCP_EV_PLAY_ITEM_RSP = 0x9C
BTP_AVRCP_EV_SEARCH_RSP = 0x9D
BTP_AVRCP_EV_ADD_TO_NOW_PLAYING_RSP = 0x9E
BTP_AVRCP_EV_GENERAL_REJECT_RSP = 0x9F

BTP_AVRCP_EV_UNIT_INFO_REQ = 0xC0
BTP_AVRCP_EV_SUBUNIT_INFO_REQ = 0xC1
BTP_AVRCP_EV_PASS_THROUGH_REQ = 0xC2
BTP_AVRCP_EV_GET_CAPS_REQ = 0xC3
BTP_AVRCP_EV_LIST_PLAYER_APP_SETTING_ATTRS_REQ = 0xC4
BTP_AVRCP_EV_LIST_PLAYER_APP_SETTING_VALS_REQ = 0xC5
BTP_AVRCP_EV_GET_CURR_PLAYER_APP_SETTING_VAL_REQ = 0xC6
BTP_AVRCP_EV_SET_PLAYER_APP_SETTING_VAL_REQ = 0xC7
BTP_AVRCP_EV_GET_PLAYER_APP_SETTING_ATTR_TEXT_REQ = 0xC8
BTP_AVRCP_EV_GET_PLAYER_APP_SETTING_VAL_TEXT_REQ = 0xC9
BTP_AVRCP_EV_INFORM_DISPLAYABLE_CHAR_SET_REQ = 0xCA
BTP_AVRCP_EV_INFORM_BATT_STATUS_OF_CT_REQ = 0xCB
BTP_AVRCP_EV_GET_ELEMENT_ATTRS_REQ = 0xCC
BTP_AVRCP_EV_GET_PLAY_STATUS_REQ = 0xCD
BTP_AVRCP_EV_REGISTER_NOTIFICATION_REQ = 0xCE
BTP_AVRCP_EV_REQ_CONTINUING_RSP_REQ = 0xCF
BTP_AVRCP_EV_ABORT_CONTINUING_RSP_REQ = 0xD0
BTP_AVRCP_EV_SET_ABSOLUTE_VOLUME_REQ = 0xD1
BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_REQ = 0xD2
BTP_AVRCP_EV_GET_FOLDER_ITEMS_REQ = 0xD3
BTP_AVRCP_EV_GET_TOTAL_NUMBER_OF_ITEMS_REQ = 0xD4
BTP_AVRCP_EV_SET_BROWSED_PLAYER_REQ = 0xD5
BTP_AVRCP_EV_CHANGE_PATH_REQ = 0xD6
BTP_AVRCP_EV_GET_ITEM_ATTRS_REQ = 0xD7
BTP_AVRCP_EV_PLAY_ITEM_REQ = 0xD8
BTP_AVRCP_EV_SEARCH_REQ = 0xD9
BTP_AVRCP_EV_ADD_TO_NOW_PLAYING_REQ = 0xDA
BTP_AVRCP_EV_GENERAL_REJECT_REQ = 0xDB

BTP_AVRCP_EV_CA_CT_CONNECTED = 0xE0
BTP_AVRCP_EV_CA_CT_DISCONNECTED = 0xE1
BTP_AVRCP_EV_GET_IMAGE_PROPS_RSP = 0xE2
BTP_AVRCP_EV_GET_IMAGE_RSP = 0xE3
BTP_AVRCP_EV_GET_LINKED_THUMBNAIL_RSP = 0xE4

AVRCP_CONNECT_MODE_RFCOMM = 0x00
AVRCP_CONNECT_MODE_L2CAP = 0x01
