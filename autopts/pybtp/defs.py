...
BTP_AVRCP_CMD_GET_CAP = 0x09
BTP_AVRCP_CMD_LIST_PLAYER_APP_ATTR = 0x0A
BTP_AVRCP_CMD_LIST_PLAYER_APP_VAL = 0x0B
BTP_AVRCP_CMD_GET_CUR_PLAYER_APP_VAL = 0x0C
BTP_AVRCP_CMD_SET_PLAYER_APP_VAL = 0x0D
BTP_AVRCP_CMD_GET_PLAYER_APP_ATTR_TXT = 0x0E
BTP_AVRCP_CMD_GET_PLAYER_APP_VAL_TXT = 0x0F
BTP_AVRCP_CMD_INFORM_DISP_CHARSET = 0x10
BTP_AVRCP_CMD_INFORM_BATT_STATUS_OF_CT = 0x11
BTP_AVRCP_CMD_GET_ELEM_ATTR = 0x12
BTP_AVRCP_CMD_GET_PLAY_STATUS = 0x13
BTP_AVRCP_CMD_REGISTER_NOTIFY = 0x14
BTP_AVRCP_CMD_REQUEST_CONTINUING_RSP = 0x15
BTP_AVRCP_CMD_ABORT_CONTINUING_RSP = 0x16
BTP_AVRCP_CMD_SET_ABSOLUTE_VOL = 0x17
BTP_AVRCP_CMD_SET_ADDRESSED_PLAYER = 0x18
BTP_AVRCP_CMD_GET_FOLDER_ITEM = 0x19
BTP_AVRCP_CMD_GET_TOTAL_NUM = 0x1A
BTP_AVRCP_CMD_SET_BROWSED_PLAYER = 0x1B
BTP_AVRCP_CMD_CHANGE_PATH = 0x1C
BTP_AVRCP_CMD_GET_ITEM_ATTR = 0x1D
BTP_AVRCP_CMD_PLAY_ITEM = 0x1E
BTP_AVRCP_CMD_SEARCH = 0x1F
BTP_AVRCP_CMD_ADD_TO_NOW = 0x20
BTP_AVRCP_CMD_GEN_REJECT = 0x21
BTP_AVRCP_CMD_TG_REGISTER_NOTIFY = 0x22
...
BTP_AVRCP_EV_GET_CAP_RSP = 0x87
BTP_AVRCP_EV_LIST_PLAYER_APP_ATTR_RSP = 0x88
BTP_AVRCP_EV_LIST_PLAYER_APP_VAL_RSP = 0x89
BTP_AVRCP_EV_GET_CUR_PLAYER_APP_VAL_RSP = 0x8A
BTP_AVRCP_EV_SET_PLAYER_APP_VAL_RSP = 0x8B
BTP_AVRCP_EV_GET_PLAYER_APP_ATTR_TXT_RSP = 0x8C
BTP_AVRCP_EV_GET_PLAYER_APP_VAL_TXT_RSP = 0x8D
BTP_AVRCP_EV_INFORM_DISP_CHARSET_RSP = 0x8E
BTP_AVRCP_EV_INFORM_BATT_STATUS_OF_CT_RSP = 0x8F
BTP_AVRCP_EV_GET_ELEM_ATTR_RSP = 0x90
BTP_AVRCP_EV_GET_PLAY_STATUS_RSP = 0x91
BTP_AVRCP_EV_REGISTER_NOTIFY_RSP = 0x92
BTP_AVRCP_EV_REQUEST_CONTINUING_RSP_RSP = 0x93
BTP_AVRCP_EV_ABORT_CONTINUING_RSP_RSP = 0x94
BTP_AVRCP_EV_SET_ABSOLUTE_VOL_RSP = 0x95
BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_RSP = 0x96
BTP_AVRCP_EV_GET_FOLDER_ITEM_RSP = 0x97
BTP_AVRCP_EV_GET_TOTAL_NUM_RSP = 0x98
BTP_AVRCP_EV_SET_BROWSED_PLAYER_RSP = 0x99
BTP_AVRCP_EV_CHANGE_PATH_RSP = 0x9A
BTP_AVRCP_EV_GET_ITEM_ATTR_RSP = 0x9B
BTP_AVRCP_EV_PLAY_ITEM_RSP = 0x9C
BTP_AVRCP_EV_SEARCH_RSP = 0x9D
BTP_AVRCP_EV_ADD_TO_NOW_RSP = 0x9E
BTP_AVRCP_EV_GEN_REJECT_RSP = 0x9F

BTP_AVRCP_EV_UNIT_INFO_REQ = 0xC0
BTP_AVRCP_EV_SUBUNIT_INFO_REQ = 0xC1
BTP_AVRCP_EV_PASS_THROUGH_REQ = 0xC2
BTP_AVRCP_EV_GET_CAP_REQ = 0xC3
BTP_AVRCP_EV_LIST_PLAYER_APP_ATTR_REQ = 0xC4
BTP_AVRCP_EV_LIST_PLAYER_APP_VAL_REQ = 0xC5
BTP_AVRCP_EV_GET_CUR_PLAYER_APP_VAL_REQ = 0xC6
BTP_AVRCP_EV_SET_PLAYER_APP_VAL_REQ = 0xC7
BTP_AVRCP_EV_GET_PLAYER_APP_ATTR_TXT_REQ = 0xC8
BTP_AVRCP_EV_GET_PLAYER_APP_VAL_TXT_REQ = 0xC9
BTP_AVRCP_EV_INFORM_DISP_CHARSET_REQ = 0xCA
BTP_AVRCP_EV_INFORM_BATT_STATUS_OF_CT_REQ = 0xCB
BTP_AVRCP_EV_GET_ELEM_ATTR_REQ = 0xCC
BTP_AVRCP_EV_GET_PLAY_STATUS_REQ = 0xCD
BTP_AVRCP_EV_REGISTER_NOTIFY_REQ = 0xCE
BTP_AVRCP_EV_REQUEST_CONTINUING_RSP_REQ = 0xCF
BTP_AVRCP_EV_ABORT_CONTINUING_RSP_REQ = 0xD0
BTP_AVRCP_EV_SET_ABSOLUTE_VOL_REQ = 0xD1
BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_REQ = 0xD2
BTP_AVRCP_EV_GET_FOLDER_ITEM_REQ = 0xD3
BTP_AVRCP_EV_GET_TOTAL_NUM_REQ = 0xD4
BTP_AVRCP_EV_SET_BROWSED_PLAYER_REQ = 0xD5
BTP_AVRCP_EV_CHANGE_PATH_REQ = 0xD6
BTP_AVRCP_EV_GET_ITEM_ATTR_REQ = 0xD7
BTP_AVRCP_EV_PLAY_ITEM_REQ = 0xD8
BTP_AVRCP_EV_SEARCH_REQ = 0xD9
BTP_AVRCP_EV_ADD_TO_NOW_REQ = 0xDA
BTP_AVRCP_EV_GEN_REJECT_REQ = 0xDB
