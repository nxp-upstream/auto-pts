...
BTP_SERVICE_ID_HFP_HF = 0x21
BTP_SERVICE_ID_HFP_AG = 0x22
BTP_SERVICE_ID_A2DP = 0x23
BTP_SERVICE_ID_AVDTP = 0x24
BTP_SERVICE_ID_AVRCP = 0x25
BTP_SERVICE_ID_AVCTP = 0x26
BTP_SERVICE_ID_SPP = 0x27
BTP_SERVICE_ID_PBAP = 0x28
BTP_SERVICE_ID_MAP = 0x29
# GENERATOR append 1
...
BTP_GAP_CMD_SUBRATE_REQUEST = 0x2b
BTP_GAP_CMD_BIG_CREATE_SYNC_BCODE_SIZE = 0x10
BTP_GAP_CMD_BIG_CREATE_SYNC = 0x2c
BTP_GAP_CMD_CREATE_BIG_PHY_1M = 0x01
BTP_GAP_CMD_CREATE_BIG_PHY_2M = 0x02
BTP_GAP_CMD_CREATE_BIG_PHY_CODED = 0x04
BTP_GAP_CMD_CREATE_BIG_PACKING_SEQUENTIAL = 0x00
BTP_GAP_CMD_CREATE_BIG_PACKING_INTERLEAVED = 0x01
BTP_GAP_CMD_CREATE_BIG_FRAMING_UNFRAMED = 0x00
BTP_GAP_CMD_CREATE_BIG_FRAMING_FRAMED_SEG = 0x01
BTP_GAP_CMD_CREATE_BIG_FRAMING_FRAMED_UNSEG = 0x02
BTP_GAP_CMD_CREATE_BIG = 0x2d
BTP_GAP_CMD_BIS_BROADCAST = 0x2e
BTP_GAP_CMD_SET_EAD_KEY_MATERIAL = 0x31
BTP_GAP_CMD_ENCRYPT_EAD_DATA = 0x32
BTP_GAP_CMD_DECRYPT_EAD_DATA = 0x33
BTP_GAP_CMD_PAWR_CONFIGURE = 0x34
BTP_GAP_CMD_CONFIGURE_SECURITY_MODE = 0x35
BTP_GAP_CMD_SET_EXTENDED_INQUIRY_RESPONSE = 0x36
...
BTP_GAP_EV_SUBRATE_CHANGE = 0x92
BTP_GAP_EV_BIG_SYNC_ESTABLISHED = 0x93
BTP_GAP_EV_BIG_SYNC_LOST = 0x94
BTP_GAP_EV_BIS_DATA_PATH_SETUP = 0x95
BTP_GAP_EV_BIS_STREAM_RECEIVED_FLAGS_VALID = 0x01
BTP_GAP_EV_BIS_STREAM_RECEIVED_FLAGS_ERROR = 0x02
BTP_GAP_EV_BIS_STREAM_RECEIVED_FLAGS_LOST = 0x04
BTP_GAP_EV_BIS_STREAM_RECEIVED_FLAGS_TS = 0x08
BTP_GAP_EV_BIS_STREAM_RECEIVED = 0x96
BTP_GAP_EV_PERIODIC_BIGINFO = 0x97
BTP_GAP_EV_PEER_CAR_RECEIVED = 0x98
...
BTP_GATT_CMD_GET_HANDLE_FROM_UUID = 0x22
BTP_GATT_CMD_REMOVE_HANDLE_FROM_DB = 0x23
...
BTP_L2CAP_CMD_ECHO_REQ = 0x0a
BTP_L2CAP_CMD_CONNECT_V2 = 0x0b
L2CAP_CONNECT_V2_MODE_NONE = 0x00
L2CAP_CONNECT_V2_MODE_BASIC = 0x00
L2CAP_CONNECT_V2_MODE_RET = 0x01
L2CAP_CONNECT_V2_MODE_FC = 0x02
L2CAP_CONNECT_V2_MODE_ERET = 0x03
L2CAP_CONNECT_V2_MODE_STREAM = 0x04
L2CAP_CONNECT_V2_OPT_ECFC = 0x01
L2CAP_CONNECT_V2_OPT_HOLD_CREDIT = 0x02
L2CAP_CONNECT_V2_OPT_MODE_OPTIONAL = 0x04
L2CAP_CONNECT_V2_OPT_EXT_WIN_SIZE = 0x08
L2CAP_CONNECT_V2_OPT_NO_FCS = 0x10
L2CAP_LISTEN_V2_MODE_NONE = 0x00
L2CAP_LISTEN_V2_MODE_BASIC = 0x00
L2CAP_LISTEN_V2_MODE_RET = 0x01
L2CAP_LISTEN_V2_MODE_FC = 0x02
L2CAP_LISTEN_V2_MODE_ERET = 0x03
L2CAP_LISTEN_V2_MODE_STREAM = 0x04
L2CAP_LISTEN_V2_OPT_ECFC = 0x01
L2CAP_LISTEN_V2_OPT_HOLD_CREDIT = 0x02
L2CAP_LISTEN_V2_OPT_MODE_OPTIONAL = 0x04
L2CAP_LISTEN_V2_OPT_EXT_WIN_SIZE = 0x08
L2CAP_LISTEN_V2_OPT_NO_FCS = 0x10
BTP_L2CAP_CMD_LISTEN_V2 = 0x0c
...
BTP_VCS_CMD_REGISTER = 0x07

VCS_REGISTER_FLAG_MUTED = BIT(0)
...
BTP_ASCS_EV_CIS_CONNECTED = 0x83
BTP_ASCS_EV_CIS_DISCONNECTED = 0x84
...
BTP_BAP_CMD_SCAN_DELEGATOR_ADD_SRC = 0x1a
BTP_BAP_CMD_BROADCAST_SINK_SET_BROADCAST_CODE = 0x1b
...
BTP_CSIS_CMD_SET_SIRK = 0x05
BTP_CSIS_CMD_SET_SET_SIZE = 0x06

CSIS_SIRK_TYPE_PLAINTEXT = 0x00
CSIS_SIRK_TYPE_ENCRYPTED = 0x01
CSIS_SIRK_TYPE_OOB_ONLY = 0x02
...
BTP_GMCS_CMD_PLAYER_NAME_SET = 0x07
...
BTP_TBS_CMD_REGISTER_BEARER = 0x0c
...
BTP_RFCOMM_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_RFCOMM_CMD_CONNECT = 0x02
BTP_RFCOMM_CMD_DISCONNECT = 0x03
BTP_RFCOMM_CMD_SEND_DATA = 0x04
BTP_RFCOMM_CMD_LISTEN = 0x05
BTP_RFCOMM_CMD_SEND_RPN = 0x06
BTP_RFCOMM_CMD_GET_DLC_INFO = 0x07
BTP_RFCOMM_RLS_NO_ERROR = 0x00
BTP_RFCOMM_RLS_OVERRUN_ERROR = 0x03
BTP_RFCOMM_RLS_PARITY_ERROR = 0x05
BTP_RFCOMM_RLS_FRAMING_ERROR = 0x09
BTP_RFCOMM_CMD_SEND_RLS = 0x08
BTP_RFCOMM_EV_CONNECTED = 0x80
BTP_RFCOMM_EV_DISCONNECTED = 0x81
BTP_RFCOMM_EV_DATA_RECEIVED = 0x82
BTP_RFCOMM_EV_DATA_SENT = 0x83

BTP_HFP_HF_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_HFP_HF_CMD_CONNECT = 0x02
BTP_HFP_HF_CMD_DISCONNECT = 0x03
BTP_HFP_HF_CMD_CLI = 0x04
BTP_HFP_HF_CMD_VGM = 0x05
BTP_HFP_HF_CMD_VGS = 0x06
BTP_HFP_HF_CMD_GET_OPERATOR = 0x07
BTP_HFP_HF_CMD_ACCEPT_CALL = 0x08
BTP_HFP_HF_CMD_REJECT_CALL = 0x09
BTP_HFP_HF_CMD_TERMINATE_CALL = 0x0a
BTP_HFP_HF_CMD_HOLD_INCOMING = 0x0b
BTP_HFP_HF_CMD_QUERY_RESPOND_HOLD_STATUS = 0x0c
BTP_HFP_HF_CMD_NUMBER_CALL = 0x0d
BTP_HFP_HF_CMD_MEMORY_DIAL = 0x0e
BTP_HFP_HF_CMD_REDIAL = 0x0f
BTP_HFP_HF_CMD_AUDIO_CONNECT = 0x10
BTP_HFP_HF_CMD_AUDIO_DISCONNECT = 0x11
BTP_HFP_HF_CMD_SELECT_CODEC = 0x12
BTP_HFP_HF_CMD_SET_CODECS = 0x13
BTP_HFP_HF_CMD_TURN_OFF_ECNR = 0x14
BTP_HFP_HF_CMD_CALL_WAITING_NOTIFY = 0x15
BTP_HFP_HF_CMD_RELEASE_ALL_HELD = 0x16
BTP_HFP_HF_CMD_SET_UDUB = 0x17
BTP_HFP_HF_CMD_RELEASE_ACTIVE_ACCEPT_OTHER = 0x18
BTP_HFP_HF_CMD_HOLD_ACTIVE_ACCEPT_OTHER = 0x19
BTP_HFP_HF_CMD_JOIN_CONVERSATION = 0x1a
BTP_HFP_HF_CMD_EXPLICIT_CALL_TRANSFER = 0x1b
BTP_HFP_HF_CMD_RELEASE_SPECIFIED_CALL = 0x1c
BTP_HFP_HF_CMD_PRIVATE_CONSULTATION_MODE = 0x1d
BTP_HFP_HF_CMD_VOICE_RECOGNITION = 0x1e
BTP_HFP_HF_CMD_READY_TO_ACCEPT_AUDIO = 0x1f
BTP_HFP_HF_CMD_REQUEST_PHONE_NUMBER = 0x20
BTP_HFP_HF_CMD_TRANSMIT_DTMF_CODE = 0x21
BTP_HFP_HF_CMD_QUERY_SUBSCRIBER = 0x22
BTP_HFP_HF_CMD_INDICATOR_STATUS = 0x23
BTP_HFP_HF_CMD_ENHANCED_SAFETY = 0x24
BTP_HFP_HF_CMD_BATTERY = 0x25
BTP_HFP_HF_CMD_QUERY_LIST_CURRENT_CALLS = 0x26
BTP_HFP_HF_EV_CONNECTED = 0x80
BTP_HFP_HF_EV_DISCONNECTED = 0x81
BTP_HFP_HF_EV_SCO_CONNECTED = 0x82
BTP_HFP_HF_EV_SCO_DISCONNECTED = 0x83
BTP_HFP_HF_EV_SERVICE = 0x84
BTP_HFP_HF_EV_OUTGOING = 0x85
BTP_HFP_HF_EV_REMOTE_RINGING = 0x86
BTP_HFP_HF_EV_INCOMING = 0x87
BTP_HFP_HF_EV_INCOMING_HELD = 0x88
BTP_HFP_HF_EV_CALL_ACCEPTED = 0x89
BTP_HFP_HF_EV_CALL_REJECTED = 0x8a
BTP_HFP_HF_EV_CALL_TERMINATED = 0x8b
BTP_HFP_HF_EV_CALL_HELD = 0x8c
BTP_HFP_HF_EV_CALL_RETRIEVED = 0x8d
BTP_HFP_HF_EV_SIGNAL = 0x8e
BTP_HFP_HF_EV_ROAM = 0x8f
BTP_HFP_HF_EV_BATTERY = 0x90
BTP_HFP_HF_EV_RING_INDICATION = 0x91
BTP_HFP_HF_EV_DIALING = 0x92
BTP_HFP_HF_EV_CLIP = 0x93
BTP_HFP_HF_EV_VGM = 0x94
BTP_HFP_HF_EV_VGS = 0x95
BTP_HFP_HF_EV_INBAND_RING = 0x96
BTP_HFP_HF_EV_OPERATOR = 0x97
BTP_HFP_HF_EV_CODEC_NEGOTIATE = 0x98
BTP_HFP_HF_EV_ECNR_TURN_OFF = 0x99
BTP_HFP_HF_EV_CALL_WAITING = 0x9a
BTP_HFP_HF_EV_VOICE_RECOGNITION = 0x9b
BTP_HFP_HF_EV_VRE_STATE = 0x9c
BTP_HFP_HF_EV_TEXTUAL_REPRESENTATION = 0x9d
BTP_HFP_HF_EV_REQUEST_PHONE_NUMBER = 0x9e
BTP_HFP_HF_EV_SUBSCRIBER_NUMBER = 0x9f
BTP_HFP_HF_CALL_DIR_OUTGOING = 0x00
BTP_HFP_HF_CALL_DIR_INCOMING = 0x01
BTP_HFP_HF_CALL_STATUS_ACTIVE = 0x00
BTP_HFP_HF_CALL_STATUS_HELD = 0x01
BTP_HFP_HF_CALL_STATUS_DIALING = 0x02
BTP_HFP_HF_CALL_STATUS_ALERTING = 0x03
BTP_HFP_HF_CALL_STATUS_INCOMING = 0x04
BTP_HFP_HF_CALL_STATUS_WAITING = 0x05
BTP_HFP_HF_CALL_STATUS_INCOMING_HELD = 0x06
BTP_HFP_HF_EV_QUERY_CALL = 0xa0

BTP_HFP_AG_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_HFP_AG_CMD_CONNECT = 0x02
BTP_HFP_AG_CMD_DISCONNECT = 0x03
BTP_HFP_AG_CMD_REMOTE_INCOMING = 0x04
BTP_HFP_AG_CMD_OUTGOING = 0x05
BTP_HFP_AG_CMD_REMOTE_RINGING = 0x06
BTP_HFP_AG_CMD_REMOTE_ACCEPT = 0x07
BTP_HFP_AG_CMD_REMOTE_REJECT = 0x08
BTP_HFP_AG_CMD_REMOTE_TERMINATE = 0x09
BTP_HFP_AG_CMD_ACCEPT_CALL = 0x0a
BTP_HFP_AG_CMD_REJECT_CALL = 0x0b
BTP_HFP_AG_CMD_TERMINATE_CALL = 0x0c
BTP_HFP_AG_CMD_HOLD_CALL = 0x0d
BTP_HFP_AG_CMD_RETRIEVE_CALL = 0x0e
BTP_HFP_AG_CMD_HOLD_INCOMING = 0x0f
BTP_HFP_AG_CMD_EXPLICIT_CALL_TRANSFER = 0x10
BTP_HFP_AG_CMD_AUDIO_CONNECT = 0x11
BTP_HFP_AG_CMD_AUDIO_DISCONNECT = 0x12
BTP_HFP_AG_CMD_SET_VGM = 0x13
BTP_HFP_AG_CMD_SET_VGS = 0x14
BTP_HFP_AG_CMD_SET_OPERATOR = 0x15
BTP_HFP_AG_CMD_SET_INBAND_RINGTONE = 0x16
BTP_HFP_AG_CMD_VOICE_RECOGNITION = 0x17
BTP_HFP_AG_CMD_VRE_STATE = 0x18
BTP_HFP_AG_CMD_VRE_TEXT = 0x19
BTP_HFP_AG_CMD_SET_SIGNAL_STRENGTH = 0x1a
BTP_HFP_AG_CMD_SET_ROAMING_STATUS = 0x1b
BTP_HFP_AG_CMD_SET_BATTERY_LEVEL = 0x1c
BTP_HFP_AG_CMD_SET_SERVICE_AVAILABILITY = 0x1d
BTP_HFP_AG_CMD_SET_HF_INDICATOR = 0x1e
BTP_HFP_AG_CALL_DIR_OUTGOING = 0x00
BTP_HFP_AG_CALL_DIR_INCOMING = 0x01
BTP_HFP_AG_CALL_STATUS_ACTIVE = 0x00
BTP_HFP_AG_CALL_STATUS_HELD = 0x01
BTP_HFP_AG_CALL_STATUS_DIALING = 0x02
BTP_HFP_AG_CALL_STATUS_ALERTING = 0x03
BTP_HFP_AG_CALL_STATUS_INCOMING = 0x04
BTP_HFP_AG_CALL_STATUS_WAITING = 0x05
BTP_HFP_AG_CALL_STATUS_INCOMING_HELD = 0x06
BTP_HFP_AG_CMD_SET_ONGOING_CALLS = 0x1f
BTP_HFP_AG_CMD_SET_LAST_NUMBER = 0x20
BTP_HFP_AG_CMD_SET_DEFAULT_INDICATOR_VALUE = 0x21
BTP_HFP_AG_CMD_SET_MEMORY_DIAL_MAPPING = 0x22
BTP_HFP_AG_CMD_SET_SUBSCRIBER_NUMBER = 0x23
BTP_HFP_AG_CMD_SET_VOICE_TAG_NUMBER = 0x24
BTP_HFP_AG_EV_CONNECTED = 0x80
BTP_HFP_AG_EV_DISCONNECTED = 0x81
BTP_HFP_AG_EV_SCO_CONNECTED = 0x82
BTP_HFP_AG_EV_SCO_DISCONNECTED = 0x83
BTP_HFP_AG_EV_OUTGOING = 0x84
BTP_HFP_AG_EV_INCOMING = 0x85
BTP_HFP_AG_EV_INCOMING_HELD = 0x86
BTP_HFP_AG_EV_RINGING = 0x87
BTP_HFP_AG_EV_CALL_ACCEPTED = 0x88
BTP_HFP_AG_EV_CALL_HELD = 0x89
BTP_HFP_AG_EV_CALL_RETRIEVED = 0x8a
BTP_HFP_AG_EV_CALL_REJECTED = 0x8b
BTP_HFP_AG_EV_CALL_TERMINATED = 0x8c
BTP_HFP_AG_EV_CODEC_IDS = 0x8d
BTP_HFP_AG_EV_CODEC_NEGOTIATED = 0x8e
BTP_HFP_AG_EV_AUDIO_CONNECT_REQ = 0x8f
BTP_HFP_AG_EV_VGM = 0x90
BTP_HFP_AG_EV_VGS = 0x91
BTP_HFP_AG_EV_ECNR_TURN_OFF = 0x92
BTP_HFP_AG_EV_EXPLICIT_CALL_TRANSFER = 0x93
BTP_HFP_AG_EV_VOICE_RECOGNITION = 0x94
BTP_HFP_AG_EV_READY_ACCEPT_AUDIO = 0x95
BTP_HFP_AG_EV_TRANSMIT_DTMF_CODE = 0x96
BTP_HFP_AG_EV_HF_INDICATOR_VALUE = 0x97

BTP_A2DP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_A2DP_CMD_CONNECT = 0x02
BTP_A2DP_CMD_DISCONNECT = 0x03
BTP_A2DP_CMD_REGISTER_ENDPOINT = 0x04
BTP_A2DP_CMD_DISCOVER = 0x05
BTP_A2DP_CMD_GET_CAPABILITIES = 0x06
BTP_A2DP_CMD_GET_ALL_CAPABILITIES = 0x07
BTP_A2DP_CMD_CONFIG = 0x08
BTP_A2DP_CMD_ESTABLISH = 0x09
BTP_A2DP_CMD_RELEASE = 0x0A
BTP_A2DP_CMD_START = 0x0B
BTP_A2DP_CMD_SUSPEND = 0x0C
BTP_A2DP_CMD_RECONFIG = 0x0D
BTP_A2DP_CMD_ABORT = 0x0E
BTP_A2DP_CMD_GET_CONFIG = 0x0F
BTP_A2DP_CMD_DELAY_REPORT = 0x10

BTP_A2DP_EV_CONNECTED = 0x80
BTP_A2DP_EV_DISCONNECTED = 0x81
BTP_A2DP_EV_DISCOVERED = 0x82
BTP_A2DP_EV_GET_CAPABILITIES = 0x83
BTP_A2DP_EV_GET_ALL_CAPABILITIES = 0x84
BTP_A2DP_EV_CONFIG_REQ = 0x85
BTP_A2DP_EV_CONFIG_RSP = 0x86
BTP_A2DP_EV_RECONFIG_REQ = 0x87
BTP_A2DP_EV_ESTABLISH_REQ = 0x88
BTP_A2DP_EV_ESTABLISH_RSP = 0x89
BTP_A2DP_EV_RELEASE_REQ = 0x8A
BTP_A2DP_EV_RELEASE_RSP = 0x8B
BTP_A2DP_EV_START_REQ = 0x8C
BTP_A2DP_EV_START_RSP = 0x8D
BTP_A2DP_EV_SUSPEND_REQ = 0x8E
BTP_A2DP_EV_SUSPEND_RSP = 0x8F
BTP_A2DP_EV_ABORT_REQ = 0x90
BTP_A2DP_EV_ABORT_RSP = 0x91
BTP_A2DP_EV_GET_CONFIG_REQ = 0x92
BTP_A2DP_EV_GET_CONFIG_RSP = 0x93
BTP_A2DP_EV_STREAM_RECV = 0x94
BTP_A2DP_EV_STREAM_SENT = 0x95
BTP_A2DP_EV_DELAY_REPORT_REQ = 0x96
BTP_A2DP_EV_DELAY_REPORT_RSP = 0x97

BTP_AVDTP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_AVDTP_EV_DUMMY_COMPLETED = 0x80

BTP_AVRCP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_AVRCP_CMD_CONTROL_CONNECT = 0x02
BTP_AVRCP_CMD_CONTROL_DISCONNECT = 0x03
BTP_AVRCP_CMD_BROWSING_CONNECT = 0x04
BTP_AVRCP_CMD_BROWSING_DISCONNECT = 0x05
BTP_AVRCP_CMD_UNIT_INFO = 0x06
BTP_AVRCP_CMD_SUBUNIT_INFO = 0x07
BTP_AVRCP_CMD_PASS_THROUGH = 0x08
BTP_AVRCP_CMD_GET_CAPS = 0x09
BTP_AVRCP_CMD_LIST_PLAYER_APP_SETTING_ATTRS = 0x0a
BTP_AVRCP_CMD_LIST_PLAYER_APP_SETTING_VALS = 0x0b
BTP_AVRCP_CMD_GET_CURR_PLAYER_APP_SETTING_VAL = 0x0c
BTP_AVRCP_CMD_SET_PLAYER_APP_SETTING_VAL = 0x0d
BTP_AVRCP_CMD_GET_PLAYER_APP_SETTING_ATTR_TEXT = 0x0e
BTP_AVRCP_CMD_GET_PLAYER_APP_SETTING_VAL_TEXT = 0x0f
BTP_AVRCP_CMD_GET_ELEMENT_ATTRS = 0x10
BTP_AVRCP_CMD_GET_PLAY_STATUS = 0x11
BTP_AVRCP_CMD_REGISTER_NOTIFICATION = 0x12
BTP_AVRCP_CMD_SET_ABSOLUTE_VOLUME = 0x13
BTP_AVRCP_CMD_SET_ADDRESSED_PLAYER = 0x14
BTP_AVRCP_CMD_GET_FOLDER_ITEMS = 0x15
BTP_AVRCP_CMD_GET_TOTAL_NUMBER_OF_ITEMS = 0x16
BTP_AVRCP_CMD_SET_BROWSED_PLAYER = 0x17
BTP_AVRCP_CMD_CHANGE_PATH = 0x18
BTP_AVRCP_CMD_GET_ITEM_ATTRS = 0x19
BTP_AVRCP_CMD_PLAY_ITEM = 0x1a
BTP_AVRCP_CMD_SEARCH = 0x1b
BTP_AVRCP_CMD_ADD_TO_NOW_PLAYING = 0x1c
BTP_AVRCP_CMD_TG_REGISTER_NOTIFICATION = 0x1d
BTP_AVRCP_CMD_TG_CONTROL_PLAYBACK = 0x1e
BTP_AVRCP_CMD_TG_CHANGE_PATH = 0x1f
BTP_AVRCP_CMD_CA_CT_CONNECT = 0x20
BTP_AVRCP_CMD_CA_CT_DISCONNECT = 0x21
BTP_AVRCP_CMD_GET_IMAGE_PROPS = 0x22
BTP_AVRCP_CMD_GET_IMAGE = 0x23
BTP_AVRCP_CMD_GET_LINKED_THUMBNAIL = 0x24

BTP_AVRCP_EV_CONTROL_CONNECTED = 0x80
BTP_AVRCP_EV_CONTROL_DISCONNECTED = 0x81
BTP_AVRCP_EV_BROWSING_CONNECTED = 0x82
BTP_AVRCP_EV_BROWSING_DISCONNECTED = 0x83
BTP_AVRCP_EV_UNIT_INFO_RSP = 0x84
BTP_AVRCP_EV_SUBUNIT_INFO_RSP = 0x85
BTP_AVRCP_EV_PASS_THROUGH_RSP = 0x86
BTP_AVRCP_EV_GET_CAPS_RSP = 0x87
BTP_AVRCP_EV_LIST_PLAYER_APP_SETTING_ATTRS_RSP = 0x88
BTP_AVRCP_EV_LIST_PLAYER_APP_SETTING_VALS_RSP = 0x89
BTP_AVRCP_EV_GET_CURR_PLAYER_APP_SETTING_VAL_RSP = 0x8a
BTP_AVRCP_EV_SET_PLAYER_APP_SETTING_VAL_RSP = 0x8b
BTP_AVRCP_EV_GET_PLAYER_APP_SETTING_ATTR_TEXT_RSP = 0x8c
BTP_AVRCP_EV_GET_PLAYER_APP_SETTING_VAL_TEXT_RSP = 0x8d
BTP_AVRCP_EV_GET_ELEMENT_ATTRS_RSP = 0x8e
BTP_AVRCP_EV_GET_PLAY_STATUS_RSP = 0x8f
BTP_AVRCP_EV_REGISTER_NOTIFICATION_RSP = 0x90
BTP_AVRCP_EV_SET_ABSOLUTE_VOLUME_RSP = 0x91
BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_RSP = 0x92
BTP_AVRCP_EV_GET_FOLDER_ITEMS_RSP = 0x93
BTP_AVRCP_EV_GET_TOTAL_NUMBER_OF_ITEMS_RSP = 0x94
BTP_AVRCP_EV_SET_BROWSED_PLAYER_RSP = 0x95
BTP_AVRCP_EV_CHANGE_PATH_RSP = 0x96
BTP_AVRCP_EV_GET_ITEM_ATTRS_RSP = 0x97
BTP_AVRCP_EV_PLAY_ITEM_RSP = 0x98
BTP_AVRCP_EV_SEARCH_RSP = 0x99
BTP_AVRCP_EV_ADD_TO_NOW_PLAYING_RSP = 0x9a
BTP_AVRCP_EV_CA_CT_CONNECTED = 0x9b
BTP_AVRCP_EV_CA_CT_DISCONNECTED = 0x9c
BTP_AVRCP_EV_GET_IMAGE_PROPS_RSP = 0x9d
BTP_AVRCP_EV_GET_IMAGE_RSP = 0x9e
BTP_AVRCP_EV_GET_LINKED_THUMBNAIL_RSP = 0x9f

BTP_AVCTP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_AVCTP_EV_DUMMY_COMPLETED = 0x80

BTP_SPP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_SPP_CMD_DISCOVER = 0x02
BTP_SPP_CMD_REGISTER_SERVER = 0x03
BTP_SPP_EV_DISCOVERED = 0x80

# PBAP Commands
BTP_PBAP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_PBAP_CMD_PCE_RFCOMM_CONNECT = 0x02
BTP_PBAP_CMD_PCE_RFCOMM_DISCONNECT = 0x03
BTP_PBAP_CMD_PCE_L2CAP_CONNECT = 0x04
BTP_PBAP_CMD_PCE_L2CAP_DISCONNECT = 0x05
BTP_PBAP_CMD_PCE_CONNECT = 0x06
BTP_PBAP_CMD_PCE_DISCONNECT = 0x07
BTP_PBAP_CMD_PCE_PULL_PHONEBOOK = 0x08
BTP_PBAP_CMD_PCE_PULL_VCARD_LISTING = 0x09
BTP_PBAP_CMD_PCE_PULL_VCARD_ENTRY = 0x0a
BTP_PBAP_CMD_PCE_SET_PHONE_BOOK = 0x0b
BTP_PBAP_CMD_PCE_ABORT = 0x0c
BTP_PBAP_CMD_PSE_CONNECT_RSP = 0x0d
BTP_PBAP_CMD_PSE_DISCONNECT_RSP = 0x0e
BTP_PBAP_CMD_PSE_PULL_PHONEBOOK_RSP = 0x0f
BTP_PBAP_CMD_PSE_PULL_VCARD_LISTING_RSP = 0x10
BTP_PBAP_CMD_PSE_PULL_VCARD_ENTRY_RSP = 0x11
BTP_PBAP_CMD_PSE_SET_PHONE_BOOK_RSP = 0x12
BTP_PBAP_CMD_PSE_ABORT_RSP = 0x13
BTP_PBAP_CMD_SDP_DISCOVER = 0x14

# PBAP Events
BTP_PBAP_EV_PCE_RFCOMM_CONNECTED = 0x80
BTP_PBAP_EV_PCE_RFCOMM_DISCONNECTED = 0x81
BTP_PBAP_EV_PCE_L2CAP_CONNECTED = 0x82
BTP_PBAP_EV_PCE_L2CAP_DISCONNECTED = 0x83
BTP_PBAP_EV_PCE_CONNECTED = 0x84
BTP_PBAP_EV_PCE_DISCONNECTED = 0x85
BTP_PBAP_EV_PCE_PULL_PHONEBOOK = 0x86
BTP_PBAP_EV_PCE_PULL_VCARD_LISTING = 0x87
BTP_PBAP_EV_PCE_PULL_VCARD_ENTRY = 0x88
BTP_PBAP_EV_PCE_SET_PHONE_BOOK = 0x89
BTP_PBAP_EV_PCE_ABORT = 0x8a
BTP_PBAP_EV_PSE_RFCOMM_CONNECTED = 0x8b
BTP_PBAP_EV_PSE_RFCOMM_DISCONNECTED = 0x8c
BTP_PBAP_EV_PSE_L2CAP_CONNECTED = 0x8d
BTP_PBAP_EV_PSE_L2CAP_DISCONNECTED = 0x8e
BTP_PBAP_EV_PSE_CONNECT = 0x8f
BTP_PBAP_EV_PSE_DISCONNECT = 0x90
BTP_PBAP_EV_PSE_PULL_PHONEBOOK = 0x91
BTP_PBAP_EV_PSE_PULL_VCARD_LISTING = 0x92
BTP_PBAP_EV_PSE_PULL_VCARD_ENTRY = 0x93
BTP_PBAP_EV_PSE_SET_PHONE_BOOK = 0x94
BTP_PBAP_EV_PSE_ABORT = 0x95
BTP_PBAP_EV_SDP_DISCOVER = 0x96

BTP_MAP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_MAP_CMD_MCE_MAS_RFCOMM_CONNECT = 0x02
BTP_MAP_CMD_MCE_MAS_RFCOMM_DISCONNECT = 0x03
BTP_MAP_CMD_MCE_MAS_L2CAP_CONNECT = 0x04
BTP_MAP_CMD_MCE_MAS_L2CAP_DISCONNECT = 0x05
BTP_MAP_CMD_MCE_MAS_CONNECT = 0x06
BTP_MAP_CMD_MCE_MAS_DISCONNECT = 0x07
BTP_MAP_CMD_MCE_MAS_ABORT = 0x08
BTP_MAP_CMD_MCE_MAS_SET_FOLDER = 0x09
BTP_MAP_CMD_MCE_MAS_SET_NTF_REG = 0x0a
BTP_MAP_CMD_MCE_MAS_GET_FOLDER_LISTING = 0x0b
BTP_MAP_CMD_MCE_MAS_GET_MSG_LISTING = 0x0c
BTP_MAP_CMD_MCE_MAS_GET_MSG = 0x0d
BTP_MAP_CMD_MCE_MAS_SET_MSG_STATUS = 0x0e
BTP_MAP_CMD_MCE_MAS_PUSH_MSG = 0x0f
BTP_MAP_CMD_MCE_MAS_UPDATE_INBOX = 0x10
BTP_MAP_CMD_MCE_MAS_GET_MAS_INST_INFO = 0x11
BTP_MAP_CMD_MCE_MAS_SET_OWNER_STATUS = 0x12
BTP_MAP_CMD_MCE_MAS_GET_OWNER_STATUS = 0x13
BTP_MAP_CMD_MCE_MAS_GET_CONVO_LISTING = 0x14
BTP_MAP_CMD_MCE_MAS_SET_NTF_FILTER = 0x15
BTP_MAP_CMD_MCE_MNS_RFCOMM_DISCONNECT = 0x16
BTP_MAP_CMD_MCE_MNS_L2CAP_DISCONNECT = 0x17
BTP_MAP_CMD_MCE_MNS_CONNECT = 0x18
BTP_MAP_CMD_MCE_MNS_DISCONNECT = 0x19
BTP_MAP_CMD_MCE_MNS_ABORT = 0x1a
BTP_MAP_CMD_MCE_MNS_SEND_EVENT = 0x1b
BTP_MAP_CMD_MSE_MAS_RFCOMM_DISCONNECT = 0x1c
BTP_MAP_CMD_MSE_MAS_L2CAP_DISCONNECT = 0x1d
BTP_MAP_CMD_MSE_MAS_CONNECT = 0x1e
BTP_MAP_CMD_MSE_MAS_DISCONNECT = 0x1f
BTP_MAP_CMD_MSE_MAS_ABORT = 0x20
BTP_MAP_CMD_MSE_MAS_SET_FOLDER = 0x21
BTP_MAP_CMD_MSE_MAS_SET_NTF_REG = 0x22
BTP_MAP_CMD_MSE_MAS_GET_FOLDER_LISTING = 0x23
BTP_MAP_CMD_MSE_MAS_GET_MSG_LISTING = 0x24
BTP_MAP_CMD_MSE_MAS_GET_MSG = 0x25
BTP_MAP_CMD_MSE_MAS_SET_MSG_STATUS = 0x26
BTP_MAP_CMD_MSE_MAS_PUSH_MSG = 0x27
BTP_MAP_CMD_MSE_MAS_UPDATE_INBOX = 0x28
BTP_MAP_CMD_MSE_MAS_GET_MAS_INST_INFO = 0x29
BTP_MAP_CMD_MSE_MAS_SET_OWNER_STATUS = 0x2a
BTP_MAP_CMD_MSE_MAS_GET_OWNER_STATUS = 0x2b
BTP_MAP_CMD_MSE_MAS_GET_CONVO_LISTING = 0x2c
BTP_MAP_CMD_MSE_MAS_SET_NTF_FILTER = 0x2d
BTP_MAP_CMD_MSE_MNS_RFCOMM_CONNECT = 0x2e
BTP_MAP_CMD_MSE_MNS_RFCOMM_DISCONNECT = 0x2f
BTP_MAP_CMD_MSE_MNS_L2CAP_CONNECT = 0x30
BTP_MAP_CMD_MSE_MNS_L2CAP_DISCONNECT = 0x31
BTP_MAP_CMD_MSE_MNS_CONNECT = 0x32
BTP_MAP_CMD_MSE_MNS_DISCONNECT = 0x33
BTP_MAP_CMD_MSE_MNS_ABORT = 0x34
BTP_MAP_CMD_MSE_MNS_SEND_EVENT = 0x35
BTP_MAP_CMD_SDP_DISCOVER = 0x36
BTP_MAP_EV_MCE_MAS_RFCOMM_CONNECTED = 0x80
BTP_MAP_EV_MCE_MAS_RFCOMM_DISCONNECTED = 0x81
BTP_MAP_EV_MCE_MAS_L2CAP_CONNECTED = 0x82
BTP_MAP_EV_MCE_MAS_L2CAP_DISCONNECTED = 0x83
BTP_MAP_EV_MCE_MAS_CONNECT = 0x84
BTP_MAP_EV_MCE_MAS_DISCONNECT = 0x85
BTP_MAP_EV_MCE_MAS_ABORT = 0x86
BTP_MAP_EV_MCE_MAS_SET_NTF_REG = 0x87
BTP_MAP_EV_MCE_MAS_SET_FOLDER = 0x88
BTP_MAP_EV_MCE_MAS_GET_FOLDER_LISTING = 0x89
BTP_MAP_EV_MCE_MAS_GET_MSG_LISTING = 0x8a
BTP_MAP_EV_MCE_MAS_GET_MSG = 0x8b
BTP_MAP_EV_MCE_MAS_SET_MSG_STATUS = 0x8c
BTP_MAP_EV_MCE_MAS_PUSH_MSG = 0x8d
BTP_MAP_EV_MCE_MAS_UPDATE_INBOX = 0x8e
BTP_MAP_EV_MCE_MAS_GET_MAS_INST_INFO = 0x8f
BTP_MAP_EV_MCE_MAS_SET_OWNER_STATUS = 0x90
BTP_MAP_EV_MCE_MAS_GET_OWNER_STATUS = 0x91
BTP_MAP_EV_MCE_MAS_GET_CONVO_LISTING = 0x92
BTP_MAP_EV_MCE_MAS_SET_NTF_FILTER = 0x93
BTP_MAP_EV_MCE_MNS_RFCOMM_CONNECTED = 0x94
BTP_MAP_EV_MCE_MNS_RFCOMM_DISCONNECTED = 0x95
BTP_MAP_EV_MCE_MNS_L2CAP_CONNECTED = 0x96
BTP_MAP_EV_MCE_MNS_L2CAP_DISCONNECTED = 0x97
BTP_MAP_EV_MCE_MNS_CONNECT = 0x98
BTP_MAP_EV_MCE_MNS_DISCONNECT = 0x99
BTP_MAP_EV_MCE_MNS_ABORT = 0x9a
BTP_MAP_EV_MCE_MNS_SEND_EVENT = 0x9b
BTP_MAP_EV_MSE_MAS_RFCOMM_CONNECTED = 0x9c
BTP_MAP_EV_MSE_MAS_RFCOMM_DISCONNECTED = 0x9d
BTP_MAP_EV_MSE_MAS_L2CAP_CONNECTED = 0x9e
BTP_MAP_EV_MSE_MAS_L2CAP_DISCONNECTED = 0x9f
BTP_MAP_EV_MSE_MAS_CONNECT = 0xa0
BTP_MAP_EV_MSE_MAS_DISCONNECT = 0xa1
BTP_MAP_EV_MSE_MAS_ABORT = 0xa2
BTP_MAP_EV_MSE_MAS_SET_NTF_REG = 0xa3
BTP_MAP_EV_MSE_MAS_SET_FOLDER = 0xa4
BTP_MAP_EV_MSE_MAS_GET_FOLDER_LISTING = 0xa5
BTP_MAP_EV_MSE_MAS_GET_MSG_LISTING = 0xa6
BTP_MAP_EV_MSE_MAS_GET_MSG = 0xa7
BTP_MAP_EV_MSE_MAS_SET_MSG_STATUS = 0xa8
BTP_MAP_EV_MSE_MAS_PUSH_MSG = 0xa9
BTP_MAP_EV_MSE_MAS_UPDATE_INBOX = 0xaa
BTP_MAP_EV_MSE_MAS_GET_MAS_INST_INFO = 0xab
BTP_MAP_EV_MSE_MAS_SET_OWNER_STATUS = 0xac
BTP_MAP_EV_MSE_MAS_GET_OWNER_STATUS = 0xad
BTP_MAP_EV_MSE_MAS_GET_CONVO_LISTING = 0xae
BTP_MAP_EV_MSE_MAS_SET_NTF_FILTER = 0xaf
BTP_MAP_EV_MSE_MNS_RFCOMM_CONNECTED = 0xb0
BTP_MAP_EV_MSE_MNS_RFCOMM_DISCONNECTED = 0xb1
BTP_MAP_EV_MSE_MNS_L2CAP_CONNECTED = 0xb2
BTP_MAP_EV_MSE_MNS_L2CAP_DISCONNECTED = 0xb3
BTP_MAP_EV_MSE_MNS_CONNECT = 0xb4
BTP_MAP_EV_MSE_MNS_DISCONNECT = 0xb5
BTP_MAP_EV_MSE_MNS_ABORT = 0xb6
BTP_MAP_EV_MSE_MNS_SEND_EVENT = 0xb7
BTP_MAP_EV_SDP_RECORD = 0xb8
