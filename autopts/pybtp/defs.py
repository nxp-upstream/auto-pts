...
BTP_SERVICE_ID_HID_DEVICE = 0x28
BTP_SERVICE_ID_HID_HOST = 0x29
# GENERATOR append 1
...
BTP_HID_DEVICE_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_HID_DEVICE_CMD_CONNECT = 0x02
BTP_HID_DEVICE_CMD_DISCONNECT = 0x03
BTP_HID_DEVICE_CMD_SEND_REPORT = 0x04
BTP_HID_DEVICE_CMD_REGISTER = 0x05
BTP_HID_DEVICE_CMD_UNREGISTER = 0x06
BTP_HID_DEVICE_CMD_VIRTUAL_CABLE_UNPLUG = 0x07
BTP_HID_DEVICE_CMD_ENTER_SNIFF_MODE = 0x08
BTP_HID_DEVICE_EV_CONNECTED = 0x80
BTP_HID_DEVICE_EV_DISCONNECTED = 0x81

# HID Device report types (as defined by the HID specification)
BTP_HID_DEVICE_REPORT_TYPE_INPUT = 0x01
BTP_HID_DEVICE_REPORT_TYPE_OUTPUT = 0x02
BTP_HID_DEVICE_REPORT_TYPE_FEATURE = 0x03

# HID Host commands
BTP_HID_HOST_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_HID_HOST_CMD_REGISTER = 0x02
BTP_HID_HOST_CMD_UNREGISTER = 0x03
BTP_HID_HOST_CMD_CONNECT = 0x04
BTP_HID_HOST_CMD_DISCONNECT = 0x05
BTP_HID_HOST_CMD_GET_REPORT = 0x06
BTP_HID_HOST_CMD_SET_REPORT = 0x07
BTP_HID_HOST_CMD_GET_PROTOCOL = 0x08
BTP_HID_HOST_CMD_SET_PROTOCOL = 0x09
BTP_HID_HOST_CMD_SEND_OUTPUT_REPORT = 0x0a
BTP_HID_HOST_CMD_SUSPEND = 0x0b
BTP_HID_HOST_CMD_EXIT_SUSPEND = 0x0c
BTP_HID_HOST_CMD_VIRTUAL_CABLE_UNPLUG = 0x0d
BTP_HID_HOST_CMD_SNIFF_SUBRATING = 0x0e

# HID Host events
BTP_HID_HOST_EV_CONNECTED = 0x80
BTP_HID_HOST_EV_DISCONNECTED = 0x81
BTP_HID_HOST_EV_INPUT_REPORT = 0x82
BTP_HID_HOST_EV_GET_REPORT = 0x83
BTP_HID_HOST_EV_SET_REPORT = 0x84
BTP_HID_HOST_EV_GET_PROTOCOL = 0x85
BTP_HID_HOST_EV_SET_PROTOCOL = 0x86

# HID Host report types (as defined by the HID specification)
BTP_HID_HOST_REPORT_TYPE_INPUT = 0x01
BTP_HID_HOST_REPORT_TYPE_OUTPUT = 0x02
BTP_HID_HOST_REPORT_TYPE_FEATURE = 0x03

# HID Host protocol modes
BTP_HID_HOST_PROTOCOL_BOOT_MODE = 0x00
BTP_HID_HOST_PROTOCOL_REPORT_MODE = 0x01

# HID Host handshake result codes
BTP_HID_HOST_HS_RSP_SUCCESS = 0x00
