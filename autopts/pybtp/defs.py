...
BTP_BIP_CMD_READ_SUPPORTED_COMMANDS = 0x01
BTP_BIP_CMD_CONNECT_RFCOMM = 0x03
BTP_BIP_CMD_DISCONNECT_RFCOMM = 0x04
BTP_BIP_CMD_CONNECT_L2CAP = 0x06
BTP_BIP_CMD_DISCONNECT_L2CAP = 0x07
BTP_BIP_CMD_SDP_DISCOVER = 0x09
BTP_BIP_CMD_SERVER_REGISTER = 0x0a
BTP_BIP_CMD_SERVER_UNREGISTER = 0x0b
BTP_BIP_CMD_CLIENT_CONNECT = 0x0c
BTP_BIP_CMD_OBEX_DISCONNECT = 0x0d
BTP_BIP_CMD_OBEX_ABORT = 0x0e
BTP_BIP_CMD_CONNECT_RSP = 0x0f
BTP_BIP_CMD_DISCONNECT_RSP = 0x10
BTP_BIP_CMD_ABORT_RSP = 0x11
BTP_BIP_CMD_GET_CAPABILITIES = 0x12
BTP_BIP_CMD_GET_CAPABILITIES_RSP = 0x13
BTP_BIP_CMD_GET_IMAGE_LIST = 0x14
BTP_BIP_CMD_GET_IMAGE_LIST_RSP = 0x15
BTP_BIP_CMD_GET_IMAGE_PROPERTIES = 0x16
BTP_BIP_CMD_GET_IMAGE_PROPERTIES_RSP = 0x17
BTP_BIP_CMD_GET_IMAGE = 0x18
BTP_BIP_CMD_GET_IMAGE_RSP = 0x19
BTP_BIP_CMD_GET_LINKED_THUMBNAIL = 0x1a
BTP_BIP_CMD_GET_LINKED_THUMBNAIL_RSP = 0x1b
BTP_BIP_CMD_GET_LINKED_ATTACHMENT = 0x1c
BTP_BIP_CMD_GET_LINKED_ATTACHMENT_RSP = 0x1d
BTP_BIP_CMD_GET_PARTIAL_IMAGE = 0x1e
BTP_BIP_CMD_GET_PARTIAL_IMAGE_RSP = 0x1f
BTP_BIP_CMD_GET_MONITORING_IMAGE = 0x20
BTP_BIP_CMD_GET_MONITORING_IMAGE_RSP = 0x21
BTP_BIP_CMD_GET_STATUS = 0x22
BTP_BIP_CMD_GET_STATUS_RSP = 0x23
BTP_BIP_CMD_PUT_IMAGE = 0x24
BTP_BIP_CMD_PUT_IMAGE_RSP = 0x25
BTP_BIP_CMD_PUT_LINKED_THUMBNAIL = 0x26
BTP_BIP_CMD_PUT_LINKED_THUMBNAIL_RSP = 0x27
BTP_BIP_CMD_PUT_LINKED_ATTACHMENT = 0x28
BTP_BIP_CMD_PUT_LINKED_ATTACHMENT_RSP = 0x29
BTP_BIP_CMD_REMOTE_DISPLAY = 0x2a
BTP_BIP_CMD_REMOTE_DISPLAY_RSP = 0x2b
BTP_BIP_CMD_DELETE_IMAGE = 0x2c
BTP_BIP_CMD_DELETE_IMAGE_RSP = 0x2d
BTP_BIP_CMD_START_PRINT = 0x2e
BTP_BIP_CMD_START_PRINT_RSP = 0x2f
BTP_BIP_CMD_START_ARCHIVE = 0x30
BTP_BIP_CMD_START_ARCHIVE_RSP = 0x31
BTP_BIP_CMD_SECOND_SERVER_REGISTER = 0x32
BTP_BIP_CMD_SECOND_CONNECT = 0x33
BTP_BIP_CMD_SECOND_OBEX_DISCONNECT = 0x34
BTP_BIP_CMD_SECOND_OBEX_ABORT = 0x35
BTP_BIP_CMD_SECOND_CONNECT_RSP = 0x36
BTP_BIP_CMD_SECOND_DISCONNECT_RSP = 0x37
BTP_BIP_CMD_SECOND_ABORT_RSP = 0x38
BTP_BIP_CMD_SECOND_SERVER_UNREGISTER = 0x39
BTP_BIP_CMD_SECOND_GET_CAPABILITIES_RSP = 0x3a
BTP_BIP_CMD_SECOND_GET_IMAGE_LIST_RSP = 0x3b
BTP_BIP_CMD_SECOND_GET_IMAGE_PROPERTIES_RSP = 0x3c
BTP_BIP_CMD_SECOND_GET_IMAGE_RSP = 0x3d
BTP_BIP_CMD_SECOND_GET_LINKED_THUMBNAIL_RSP = 0x3e
BTP_BIP_CMD_SECOND_GET_LINKED_ATTACHMENT_RSP = 0x3f
BTP_BIP_CMD_SECOND_DELETE_IMAGE_RSP = 0x40
BTP_BIP_CMD_SECOND_CONNECT_L2CAP = 0x41
BTP_BIP_CMD_SECOND_CONNECT_RFCOMM = 0x42
BTP_BIP_CMD_SECOND_GET_IMAGE_LIST = 0x43
BTP_BIP_CMD_SECOND_GET_CAPABILITIES = 0x44
BTP_BIP_CMD_SECOND_GET_IMAGE_PROPERTIES = 0x45
BTP_BIP_CMD_SECOND_GET_IMAGE = 0x46
BTP_BIP_CMD_SECOND_GET_LINKED_THUMBNAIL = 0x47
BTP_BIP_CMD_SECOND_GET_LINKED_ATTACHMENT = 0x48
BTP_BIP_CMD_SECOND_GET_PARTIAL_IMAGE = 0x49
BTP_BIP_CMD_SECOND_DELETE_IMAGE = 0x4a
BTP_BIP_CMD_SECOND_DISCONNECT_L2CAP = 0x4b
BTP_BIP_CMD_SECOND_DISCONNECT_RFCOMM = 0x4c

BTP_BIP_EV_RFCOMM_CONNECTED = 0x80

BTP_BIP_EV_RFCOMM_DISCONNECTED = 0x81
BTP_BIP_EV_L2CAP_CONNECTED = 0x82
BTP_BIP_EV_L2CAP_DISCONNECTED = 0x83
BTP_BIP_EV_SERVER_CONNECT_REQ = 0x84
BTP_BIP_EV_SERVER_DISCONNECT_REQ = 0x85
BTP_BIP_EV_SERVER_ABORT_REQ = 0x86
BTP_BIP_EV_SERVER_GET_CAPS_REQ = 0x87
BTP_BIP_EV_SERVER_GET_IMAGE_LIST_REQ = 0x88
BTP_BIP_EV_SERVER_GET_IMAGE_PROPERTIES_REQ = 0x89
BTP_BIP_EV_SERVER_GET_IMAGE_REQ = 0x8a
BTP_BIP_EV_SERVER_GET_LINKED_THUMBNAIL_REQ = 0x8b
BTP_BIP_EV_SERVER_GET_LINKED_ATTACHMENT_REQ = 0x8c
BTP_BIP_EV_SERVER_GET_PARTIAL_IMAGE_REQ = 0x8d
BTP_BIP_EV_SERVER_GET_MONITORING_IMAGE_REQ = 0x8e
BTP_BIP_EV_SERVER_GET_STATUS_REQ = 0x8f
BTP_BIP_EV_SERVER_PUT_IMAGE_REQ = 0x90
BTP_BIP_EV_SERVER_PUT_LINKED_THUMBNAIL_REQ = 0x91
BTP_BIP_EV_SERVER_PUT_LINKED_ATTACHMENT_REQ = 0x92
BTP_BIP_EV_SERVER_REMOTE_DISPLAY_REQ = 0x93
BTP_BIP_EV_SERVER_DELETE_IMAGE_REQ = 0x94
BTP_BIP_EV_SERVER_START_PRINT_REQ = 0x95
BTP_BIP_EV_SERVER_START_ARCHIVE_REQ = 0x96
BTP_BIP_EV_CLIENT_CONNECTED = 0x97
BTP_BIP_EV_CLIENT_DISCONNECTED = 0x98
BTP_BIP_EV_CLIENT_ABORTED = 0x99
BTP_BIP_EV_CLIENT_GET_CAPS_RSP = 0x9a
BTP_BIP_EV_CLIENT_GET_IMAGE_LIST_RSP = 0x9b
BTP_BIP_EV_CLIENT_GET_IMAGE_PROPERTIES_RSP = 0x9c
BTP_BIP_EV_CLIENT_GET_IMAGE_RSP = 0x9d
BTP_BIP_EV_CLIENT_GET_LINKED_THUMBNAIL_RSP = 0x9e
BTP_BIP_EV_CLIENT_GET_LINKED_ATTACHMENT_RSP = 0x9f
BTP_BIP_EV_CLIENT_GET_PARTIAL_IMAGE_RSP = 0xa0
BTP_BIP_EV_CLIENT_GET_MONITORING_IMAGE_RSP = 0xa1
BTP_BIP_EV_CLIENT_GET_STATUS_RSP = 0xa2
BTP_BIP_EV_CLIENT_PUT_IMAGE_RSP = 0xa3
BTP_BIP_EV_CLIENT_PUT_LINKED_THUMBNAIL_RSP = 0xa4
BTP_BIP_EV_CLIENT_PUT_LINKED_ATTACHMENT_RSP = 0xa5
BTP_BIP_EV_CLIENT_REMOTE_DISPLAY_RSP = 0xa6
BTP_BIP_EV_CLIENT_DELETE_IMAGE_RSP = 0xa7
BTP_BIP_EV_CLIENT_START_PRINT_RSP = 0xa8
BTP_BIP_EV_CLIENT_START_ARCHIVE_RSP = 0xa9
BTP_BIP_EV_SDP_DISCOVERED = 0xaa
BTP_BIP_EV_SECOND_SERVER_CONNECT_REQ = 0xab
BTP_BIP_EV_SECOND_SERVER_DISCONNECT_REQ = 0xac
BTP_BIP_EV_SECOND_SERVER_ABORT_REQ = 0xad
BTP_BIP_EV_SECOND_CLIENT_CONNECTED = 0xae
BTP_BIP_EV_SECOND_CLIENT_DISCONNECTED = 0xaf
BTP_BIP_EV_SECOND_CLIENT_ABORTED = 0xb0
BTP_BIP_EV_SECOND_SERVER_GET_CAPS_REQ = 0xb1
BTP_BIP_EV_SECOND_SERVER_GET_IMAGE_LIST_REQ = 0xb2
BTP_BIP_EV_SECOND_SERVER_GET_IMAGE_PROPERTIES_REQ = 0xb3
BTP_BIP_EV_SECOND_SERVER_GET_IMAGE_REQ = 0xb4
BTP_BIP_EV_SECOND_SERVER_GET_LINKED_THUMBNAIL_REQ = 0xb5
BTP_BIP_EV_SECOND_SERVER_GET_LINKED_ATTACHMENT_REQ = 0xb6
BTP_BIP_EV_SECOND_SERVER_DELETE_IMAGE_REQ = 0xb7
BTP_BIP_EV_SECOND_CLIENT_GET_CAPS_RSP = 0xb8
BTP_BIP_EV_SECOND_CLIENT_GET_IMAGE_LIST_RSP = 0xb9
BTP_BIP_EV_SECOND_CLIENT_GET_IMAGE_PROPERTIES_RSP = 0xba
BTP_BIP_EV_SECOND_CLIENT_GET_IMAGE_RSP = 0xbb
BTP_BIP_EV_SECOND_CLIENT_GET_LINKED_THUMBNAIL_RSP = 0xbc
BTP_BIP_EV_SECOND_CLIENT_GET_LINKED_ATTACHMENT_RSP = 0xbd
BTP_BIP_EV_SECOND_CLIENT_GET_PARTIAL_IMAGE_RSP = 0xbe
BTP_BIP_EV_SECOND_CLIENT_DELETE_IMAGE_RSP = 0xbf
BTP_BIP_EV_SECOND_RFCOMM_CONNECTED = 0xc0
BTP_BIP_EV_SECOND_RFCOMM_DISCONNECTED = 0xc1
BTP_BIP_EV_SECOND_L2CAP_CONNECTED = 0xc2
BTP_BIP_EV_SECOND_L2CAP_DISCONNECTED = 0xc3
