...
supported_svcs_cmds = {
    ...
    "HFP": {
        "service": 1 << defs.BTP_SERVICE_ID_HFP,
        "supported_commands": defs.BTP_HFP_CMD_READ_SUPPORTED_COMMANDS
    },
    # GENERATOR append 1
}
...
reg_unreg_service = {
    ...
    "hfp_reg": (defs.BTP_SERVICE_ID_CORE, defs.BTP_CORE_CMD_REGISTER_SERVICE,
                 defs.BTP_INDEX_NONE, defs.BTP_SERVICE_ID_HFP),
    # GENERATOR append 2
