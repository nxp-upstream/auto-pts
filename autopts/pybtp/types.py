...
class MAPAppParam:
    ...
    FILTER_MSG_TYPE = 0x03
    FILTER_PERIOD_BEGIN = 0x04
    FILTER_PERIOD_END = 0x05
    FILTER_READ_STATUS = 0x06
    FILTER_RECIPIENT = 0x07
    FILTER_ORIGINATOR = 0x08
    FILTER_PRIORITY = 0x09
    ATTACHMENT = 0x0A
    TRANSPARENT = 0x0B
    RETRY = 0x0C
    NEW_MSG = 0x0D
    ...
    CHAT_STATE = 0x21
    CONVO_ID = 0x22
    FOLDER_VER_CNTR = 0x23
    FILTER_MSG_HANDLE = 0x24
    NTF_FILTER_MASK = 0x25
    CONVO_PARAM_MASK = 0x26
    OWNER_UCI = 0x27
    EXT_DATA = 0x28
